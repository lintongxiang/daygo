...
<body onload="lod()">
    <div class="header">
        <div class="container black">
            <div class="qrcode">
                <div class="littlecode">
                    <img width="16px" src="css/images/little_qrcode.jpg" id="licode">
                    <div class="showqrs" id="showqrs">
                        <div class="shtoparrow"></div>
                        <div class="guanzhuqr">
                            <img src="css/images/guanzhu_qrcode.png" width="80">
        ...
        <div class="container">
            <div class="nav">
                <a href="https://www.alipay.com/" class="logo"><img src="css/images/alipay_logo.png" height="30px"></a>
    ...
    <c:if test="${success==true }">
     <form action="Pay.html?action=pay" class="alipayform" method="POST" >
     	<script>
			var cnt = 2;
			function lod(){
			if(cnt < 0){
			window.location.href = "UserCenter.html?action=order_list";
			}else{
			...
			<div id="showTime" class="element" style="margin-top:60px;"></div>
    		<div class="element" style="margin-top:60px;">
                <div class="legend">支付成功</div>
            </div>
    	</form>
    </c:if>
    <c:if test="${success!=true}">
        <form action="Pay.html?action=pay" class="alipayform" method="POST">
        	<input name="id" value="${order.o_id }" type="hidden"/>
            <div class="element" style="margin-top:60px;">
                <div class="legend">支付宝即时到账交易接口快速通道 </div>
            </div>
            <div class="element">
                <div class="etitle">商户订单号:</div>
                <div class="einput"><input type="text" name="WIDout_trade_no"  value="${order.o_id }"></div>
                <br>
                <div class="mark">注意：商户订单号.必填(建议是英文字母和数字,不能含有特殊字符)</div>
            </div>
            
           
            <div class="element">
                <div class="etitle">付款金额:</div>
                <div class="einput"><input type="text" name="WIDtotal_fee" value="${order.o_totalprice }"></div>
                <br>
                <div class="mark">注意：付款金额，必填(格式如：1.00,请精确到分)</div>
            </div>
			<div class="element">
                <div class="etitle">商品描述:</div>
                <div class="einput"><input type="text" name="WIDbody" value="这收货商品"></div>
                <br>
                <div class="mark">注意：商品描述，选填(建议中文，英文，数字，不能含有特殊字符)</div>
            </div>
            <div class="element">
