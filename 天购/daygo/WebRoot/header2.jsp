...
<a href="Login.html?action=login" class="bgNone" target="_self">请登录</a><a href="Login.html?action=reg" target="_blank"  class="popHover">注册</a>
         ...
         <div class="f_l">
           ...
           <img src="css/images/qrcode_for_hd.jpg"></a></p>
...
<div id="head">
    <div class="hd">
            <p class="heaLogo f_l"> <a href="index.jsp" target="_parent" title="天猫商城" > 
            <img src="css/images/dglogo.png" alt="天猫商城"></a> </p>
...
<div id="heaNav">
        ...
        <p class="heaNavOnly"> <a href="index.jsp" class="cur" style=" color:#fff">
    首页</a> </p>
        <ul class="heaNavNone">
                    <li class="heaNav" onmouseover="this.className='heaNav heaNav_on'" onmouseout="this.className='heaNav'" 
    
    > <a style=" color:#fff"  class="aaa"  href="Search.html?category=女装"     
    
    title="女装/内衣">女装</a> </li>
                    <li class="heaNav" onmouseover="this.className='heaNav heaNav_on'" onmouseout="this.className='heaNav'" 
    
    > <a style=" color:#fff"  class="aaa"  href="Search.html?category=男装"     
    
    title="男装/运动户外">男装</a> </li>
                    <li class="heaNav" onmouseover="this.className='heaNav heaNav_on'" onmouseout="this.className='heaNav'" 
    
    > <a style=" color:#fff"  class="aaa" href="Search.html?category=母婴玩具"     
    
    title="母婴玩具">母婴玩具</a> </li>
                    <li class="heaNav" onmouseover="this.className='heaNav heaNav_on'" onmouseout="this.className='heaNav'" 
    
    > <a style=" color:#fff"  class="aaa"  href="Search.html?category=女鞋"     
    
    title="女鞋/男鞋/箱包">女鞋</a> </li>
                    <li class="heaNav" onmouseover="this.className='heaNav heaNav_on'" onmouseout="this.className='heaNav'" 
    
    > <a style=" color:#fff"  class="aaa"  href="Search.html?category=食品"     
    
    title="食品">食品</a> </li>
                    <li class="heaNav" onmouseover="this.className='heaNav heaNav_on'" onmouseout="this.className='heaNav'" 
    
    > <a style=" color:#fff"  class="aaa"  href="Search.html?category=手机数码"     
    
    title="手机数码">手机数码</a> </li>
                    <li class="heaNav" onmouseover="this.className='heaNav heaNav_on'" onmouseout="this.className='heaNav'" 
    
    > <a style=" color:#fff"  class="aaa"  href="Search.html?category=家居"     
